...
namespace Riders.Tweakbox.Controllers
{
    ...
    public unsafe class ExtraGearsController // : IController
    {
        ...
        /// </summary>
        /// <param name="gear">The gear information.</param>
        /// <returns>A pointer to your gear data.</returns>
        public ExtremeGear* AddGear(ExtremeGear gear)
        {
            _log.WriteLine($"Adding Gear in Slot: {GearCount}");
            var gearType = gear.GearType;
            _newGears[GearCount] = gear;
            _gearToModelMap[GearCount] = (byte)gear.GearModel;
            
            var result = &_newGearsPtr[GearCount]; 
            GearCount++;

            PatchMaxGearId(GearCount - 1);
            return result;
        }
        ...
        public void SetNewGearCount(int newCount)
        {
