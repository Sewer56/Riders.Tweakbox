...
namespace Riders.Netplay.Messages.Reliable.Structs.Gameplay
{
    ...
    /// </summary>
    public struct MovementFlagsMsg : IEquatable<MovementFlagsMsg>, IBitPackable<MovementFlagsMsg>
    {
        ...
        /// <inheritdoc />
        public MovementFlagsMsg FromStream(BitStream stream) => new MovementFlagsMsg((MovementFlags)stream.Read<short>(SizeOfEntry));

        /// <inheritdoc />
        public void ToStream(BitStream stream) => stream.Write(Modes, SizeOfEntry);
